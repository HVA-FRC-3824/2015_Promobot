 ...
 *
 */
public class  AimLow extends Command {
    ...
    protected void initialize() {
    	...
    	if (Robot.cannonActuator.getPosition() >= Constants.LOW_SETPOINT) {
    		
    		Robot.cannonActuator.setPositionUpSetpoint(Constants.LOW_SETPOINT);
    		...
    		Robot.cannonActuator.setPositionDownSetpoint(Constants.LOW_SETPOINT);
    		Robot.cannonActuator.resetPID();
            Robot.cannonActuator.setOutputRange();
    ...
    protected boolean isFinished() {
    	...
    	if ((Robot.cannonActuator.getPosition() > (Constants.LOW_SETPOINT - Constants.TOLERANCE)) && (Robot.cannonActuator.getPosition() < Constants.LOW_SETPOINT + Constants.TOLERANCE)) {
