 ...
 *
 */
public class  AimNormal extends Command {
    ...
    protected void initialize() {
    	...
    	if (Robot.cannonActuator.getPosition() >= Constants.NORMAL_SETPOINT) {
    		
    		Robot.cannonActuator.setPositionUpSetpoint(Constants.NORMAL_SETPOINT);
    		...
    		Robot.cannonActuator.setPositionDownSetpoint(Constants.NORMAL_SETPOINT);
    		Robot.cannonActuator.resetPID();
            Robot.cannonActuator.setOutputRange();
    ...
    protected boolean isFinished() {
    	...
    	if ((Robot.cannonActuator.getPosition() > (Constants.NORMAL_SETPOINT - Constants.TOLERANCE)) && (Robot.cannonActuator.getPosition() < Constants.NORMAL_SETPOINT + Constants.TOLERANCE)) {
