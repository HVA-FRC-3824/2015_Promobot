...
public class Robot extends IterativeRobot {
    ...
    public void teleopPeriodic() {
        ...
        SmartDashboard.putNumber("Bat Sensor Voltage", Robot.humanSafetySensor.getBatSensor().getVoltage());
        SmartDashboard.putNumber("Bat Sensor Range", (Robot.humanSafetySensor.getBatSensor().getVoltage()/Constants.SCALED_VOLTAGE_PER_INCH) * 10);
        ...
        SmartDashboard.putBoolean("Cannon Safety Override", Robot.humanSafetySensor.override);
        
        if (Robot.cannonActuator.isPositionUpPIDEnabled() == true) {
        	
        	SmartDashboard.putNumber("Current Position Setpoint", Robot.cannonActuator.getPositionUpSetpoint());
        	SmartDashboard.putNumber("Current Tolerance", Constants.TOLERANCE);
        	
        }
        
        else {
        	
        	if (Robot.cannonActuator.isPositionDownPIDEnabled() == true) {
        	
            SmartDashboard.putNumber("Current Position Setpoint", Robot.cannonActuator.getPositionDownSetpoint());
            SmartDashboard.putNumber("Current Tolerance", Constants.TOLERANCE);
